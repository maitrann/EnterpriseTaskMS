...
-- Clean install script for portfolio/demo environments.
--
-- HOW TO USE:
-- 1) Supabase Dashboard > SQL Editor > New query.
-- 2) Copy this whole script.
-- 3) Run.
--
-- WARNING:
-- - This script DROPs project tables/types/functions in public schema.
-- - It does NOT drop auth schema or auth.users.
-- - Use only when there is no important production data.
-- ============================================================
...
DROP TABLE IF EXISTS public.embedding_index CASCADE;
DROP TABLE IF EXISTS public.ai_task_insights CASCADE;
DROP TABLE IF EXISTS public.ai_request_logs CASCADE;
DROP TABLE IF EXISTS public.ai_feature_settings CASCADE;
DROP TABLE IF EXISTS public.notification_preferences CASCADE;
DROP TABLE IF EXISTS public.notifications CASCADE;
DROP TABLE IF EXISTS public.audit_logs CASCADE;
DROP TABLE IF EXISTS public.task_comment_mentions CASCADE;
DROP TABLE IF EXISTS public.attachments CASCADE;
DROP TABLE IF EXISTS public.inter_request_messages CASCADE;
DROP TABLE IF EXISTS public.inter_department_requests CASCADE;
DROP TABLE IF EXISTS public.inter_request_sla_policies CASCADE;
...
DROP TABLE IF EXISTS public.user_department_scopes CASCADE;
...
DROP FUNCTION IF EXISTS public.has_department_scope(BIGINT) CASCADE;
DROP FUNCTION IF EXISTS public.can_access_task(UUID) CASCADE;
DROP FUNCTION IF EXISTS public.can_access_inter_request(UUID) CASCADE;
DROP FUNCTION IF EXISTS public.set_task_defaults() CASCADE;
DROP FUNCTION IF EXISTS public.validate_task_status_rules() CASCADE;
DROP FUNCTION IF EXISTS public.validate_subtask_due_date() CASCADE;
DROP FUNCTION IF EXISTS public.audit_task_changes() CASCADE;

DROP TYPE IF EXISTS public.task_status_code CASCADE;
DROP TYPE IF EXISTS public.task_priority_code CASCADE;
DROP TYPE IF EXISTS public.project_status_code CASCADE;
DROP TYPE IF EXISTS public.extension_request_status CASCADE;
DROP TYPE IF EXISTS public.inter_request_type CASCADE;
DROP TYPE IF EXISTS public.inter_request_status CASCADE;
DROP TYPE IF EXISTS public.request_priority_code CASCADE;
DROP TYPE IF EXISTS public.request_message_role CASCADE;
DROP TYPE IF EXISTS public.task_assignment_type CASCADE;
DROP TYPE IF EXISTS public.subtask_status_code CASCADE;
DROP TYPE IF EXISTS public.notification_type CASCADE;
DROP TYPE IF EXISTS public.ai_feature_code CASCADE;
DROP TYPE IF EXISTS public.ai_request_status CASCADE;
DROP TYPE IF EXISTS public.ai_risk_level CASCADE;
